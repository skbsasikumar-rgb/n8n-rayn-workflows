...
RAYN contact search uses DuckDuckGo first, then Google. Bing is not part of the active provider order because repeated live polls showed circuit-breaker failures. Serper is no longer part of the worker fallback path.
