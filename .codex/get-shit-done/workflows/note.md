...
- **Global scope**: `/Users/sasikumar/Documents/n8n/.codex/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/sasikumar/Documents/n8n/.codex/notes/`)
...
2. Glob `/Users/sasikumar/Documents/n8n/.codex/notes/*.md` (if directory exists) — global notes
...
Global (/Users/sasikumar/Documents/n8n/.codex/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/sasikumar/Documents/n8n/.codex/notes/` — works in any directory
