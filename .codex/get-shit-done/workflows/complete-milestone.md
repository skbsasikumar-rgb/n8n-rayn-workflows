...
```bash
node "/Users/sasikumar/Documents/n8n/.codex/get-shit-done/bin/gsd-tools.cjs" audit-open 2>/dev/null
```
...
**If doesn't exist:** Create from template at `/Users/sasikumar/Documents/n8n/.codex/get-shit-done/templates/retrospective.md`.
