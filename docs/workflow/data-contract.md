...
- pressure classification: `pressure_type`, `manual_pressure_type`, `classification_review_status`, `classification_review_reason`, `classification_review_notes`, `classification_reviewed_at`, `pressure_reason`, `outreach_trigger_signal`, `outreach_trigger_source_url`, `outreach_trigger_confidence`, `data_type_signal`, `problem_area`, `problem_hypothesis`, `value_asset_offer`.
