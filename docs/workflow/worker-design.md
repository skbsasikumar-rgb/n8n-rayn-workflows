...
2. Query the configured Google SERP provider with `company_name Singapore`; use Serper when OpenSERP/browser scraping is blocked by Google CAPTCHA or circuit breakers.
