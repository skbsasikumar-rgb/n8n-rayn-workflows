...
class PublicWebEnrichmentTests(unittest.TestCase):
    ...
    def test_workflow_public_enrich_controls_are_bounded(self):
        ...
        self.assertIn("page_limit: manualOverride ? 1 : (stage === 'deep_retry' ? 5 : 3)", prepare_code)
        self.assertIn("page_timeout_ms: manualOverride ? 8000 : (stage === 'deep_retry' ? 15000 : 12000)", prepare_code)
        self.assertIn("row_timeout_seconds: manualOverride ? 180 : (stage === 'deep_retry' ? 120 : 75)", prepare_code)
    ...
    def test_fast_stage_defaults_to_static_transport(self):
        ...
        self.assertIn("public_enrich_low_limit_fallback_data", source)
        self.assertIn("PUBLIC_ENRICH_TIMEOUT_FALLBACK_PAGE_LIMIT", source)
        self.assertIn("fast_static_timeout_low_limit_fallback", source)
        self.assertIn("PUBLIC_ENRICH_BROWSER_RETRY_TIMEOUT_SECONDS", source)
        ...
        self.assertIn("PUBLIC_ENRICH_STATIC_CONCURRENCY", source)
    ...
    def test_workflow_url_only_mode_does_not_enter_public_enrichment(self):
        ...
        self.assertIn("status_reason,eq,skipped_url_validation_failed", enrichment_url)
        self.assertIn("status_reason,eq,skipped_enrichment_timeout_final", enrichment_url)
    ...
    def test_workflow_keeps_sparse_successes_completed(self):
        ...
        self.assertIn("page_limit: manualOverride ? 1", prepare_code)
        self.assertIn("row_timeout_seconds: manualOverride ? 180", prepare_code)
