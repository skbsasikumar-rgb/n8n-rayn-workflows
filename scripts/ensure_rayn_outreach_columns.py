...
OUTREACH_COLUMNS: list[OutreachColumn] = [
    ...
    OutreachColumn("manual_pressure_type", "SingleSelect", "text"),
    OutreachColumn("classification_review_status", "SingleSelect", "text"),
    OutreachColumn("classification_review_reason", "LongText", "text", "360px"),
    OutreachColumn("classification_review_notes", "LongText", "text", "360px"),
    OutreachColumn("classification_reviewed_at", "DateTime", "timestamp", "220px"),
    ...
    OutreachColumn("recipient_salutation", "SingleLineText", "text"),
    OutreachColumn("email_greeting_line", "SingleLineText", "text"),
    OutreachColumn("company_display_name", "SingleLineText", "text"),
    OutreachColumn("email_track", "SingleSelect", "text"),
    OutreachColumn("funding_program", "SingleLineText", "text"),
    OutreachColumn("hia_batch_deadline", "SingleLineText", "text"),
    OutreachColumn("email_specialty", "SingleLineText", "text"),
    OutreachColumn("email_data_type", "LongText", "text", "360px"),
    ...
    OutreachColumn("email_service_line", "LongText", "text", "360px"),
    OutreachColumn("email_funding_line", "LongText", "text", "360px"),
    OutreachColumn("email_cta_line", "SingleLineText", "text"),
    OutreachColumn("email_role_frame", "LongText", "text", "360px"),
    OutreachColumn("email_1_placeholders_json", "LongText", "text", "420px"),
    OutreachColumn("email_2_tieback_line", "LongText", "text", "360px"),
    OutreachColumn("email_2_check_line", "LongText", "text", "420px"),
    OutreachColumn("email_2_route_line", "LongText", "text", "420px"),
    OutreachColumn("email_2_cta_line", "SingleLineText", "text"),
    OutreachColumn("email_2_ps_line", "LongText", "text", "420px"),
    OutreachColumn("email_2_placeholders_json", "LongText", "text", "420px"),
    OutreachColumn("email_3_close_loop_line", "LongText", "text", "360px"),
    OutreachColumn("email_3_route_line", "LongText", "text", "420px"),
    OutreachColumn("email_3_platform_line", "LongText", "text", "420px"),
    OutreachColumn("email_3_cta_line", "SingleLineText", "text"),
    OutreachColumn("email_3_placeholders_json", "LongText", "text", "420px"),
    ...
    OutreachColumn("manual_send_approval", "SingleSelect", "text", "180px"),
    OutreachColumn("manual_approved_at", "SingleLineText", "text"),
    OutreachColumn("manual_approved_by", "SingleLineText", "text"),
    OutreachColumn("manual_review_notes", "LongText", "text", "360px"),
...
SELECT_OPTIONS: dict[str, list[str]] = {
    ...
    "manual_pressure_type": ["pdpa_safeguards", "hia_regulatory", "ncss_social_service"],
    "primary_email_track": ["hia_regulatory", "pdpa_safeguards", "ncss_social_service", "not_ready"],
    "secondary_email_track": ["hia_regulatory", "pdpa_safeguards", "ncss_social_service", "not_ready"],
    "classification_review_status": ["not_needed", "review_needed", "reviewed"],
    ...
    "email_track": ["hia", "pdpa", "ncss", "not_ready"],
    "email_context_confidence": ["low", "medium", "high"],
    ...
    "outreach_variant": ["hia_healthcare", "hia_clinic", "solo_gp", "team_clinic", "dental_clinic", "allied_health", "npo_social_service", "pdpa_general", "dpo_evidence", "funding_first", "not_ready"],
