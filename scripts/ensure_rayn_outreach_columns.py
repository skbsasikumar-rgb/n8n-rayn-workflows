...
SELECT_OPTIONS: dict[str, list[str]] = {
    ...
    "manual_pressure_type": ["pdpa_safeguards", "hia_regulatory"],
    "primary_email_track": ["hia_regulatory", "pdpa_safeguards", "not_ready"],
    "secondary_email_track": ["hia_regulatory", "pdpa_safeguards", "not_ready"],
    ...
    "email_track": ["hia", "pdpa", "not_ready"],
